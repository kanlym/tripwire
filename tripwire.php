...
if (!isset($_REQUEST['system']) || empty($_REQUEST['system'])) {
	if (isset($_SERVER['HTTP_EVE_TRUSTED']) && $_SERVER['HTTP_EVE_TRUSTED'] == 'Yes') {
		header('location: ?system='.xssafe($_SERVER['HTTP_EVE_SOLARSYSTEMNAME']));
		exit();
	}
}
...
<head>
	...
	<title><?=$system?> - <?= $server == 'static.eve-apps.com' ? 'Tripwire' : 'Torpedo Delivery' ?></title>
</head>
<?php flush(); ?>
<body class="transition">
	...
	<div id="topbar">
		<span class="align-left">
			...
			<h3 id="wiki" class="pointer" data-tooltip="wiki">| <a href="wiki/" target="_blank">wiki</a></h3>
		...
		<ul>
			<li id="infoWidget" class="gridWidget" data-row="1" data-col="1" data-sizex="7" data-sizey="6" data-min-sizex="5" data-min-sizey="4" style="width: 410px; height: 350px;">
				<div class="content">
					...
					<a class="infoLink" style="float: right;" data-href='http://wh.pasta.gg/$systemName' href="" target="_blank">wormhol.es</a>
					<a class="infoLink" style="float: right;" data-href='http://eveplanets.com/eve/system/index/show/$systemName' href="" target="_blank">eveplanets&nbsp;&nbsp;</a><br/>
