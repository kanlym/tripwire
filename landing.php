...
<html lang="en">
<head>
	<title><?= $server == 'static.eve-apps.com' ? 'Tripwire' : 'Torpedo Delivery' ?></title>
...
<body>
	...
	<section class="container">
		...
		<div id="app_info">
			...
			<p>
				If you're just starting out with Tripwire or if you just want more information, please visit the <a href="/wiki/" target="_blank">Wiki</a>.
			</p>
